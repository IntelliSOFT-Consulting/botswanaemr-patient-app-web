package com.intellisoft.botswanaemrauthentication.authentication.security;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.NEVER)
                    .and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/auths/api/v1/login").permitAll()
                .antMatchers("/auths/api/v1/login/**").permitAll()
                .antMatchers("/auths/api/v1/register").permitAll()
                .antMatchers("/auths/api/v1/refresh-token").permitAll()
                .antMatchers("/auths/api/v1/resend-link").permitAll()
